...
public class InicioFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        linearAcarreos.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getActivity(), "buscar acarreo", Toast.LENGTH_SHORT).show();
                verificarDireccion("acarreo");
            }
        });
        ...
        linearMudanzas.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getActivity(), "buscarMudanza", Toast.LENGTH_SHORT).show();
                verificarDireccion("mudanza");
            }
        });
    ...
    private void verificarDireccion(final String action) {
        AlertDialog.Builder modal=new AlertDialog.Builder(getActivity());
        modal.setTitle("¿Dónde desea el vehículo?");
        final CharSequence options[]={"Mi ubicacion actual","Ingresar dirección"};
        modal.setItems(options, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                if (options[which].equals("Mi ubicacion actual")){
                    verificarDestino(action);
                }

                if (options[which].equals("Ingresar dirección")){
                    Intent intent=new Intent(getActivity(),IngresarDireccionActivity.class);
